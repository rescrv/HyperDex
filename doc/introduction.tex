...
\paragraph{Easy-to-Use:}  HyperDex is easy to use in both development and
...
the \hdhref{http://hyperdex.org/}{HyperDex website}.  The book's sources are
...
\item \hdhref{https://groups.google.com/group/hyperdex-discuss}{HyperDex Mailing List}:
...
\item \hdhref{http://webchat.freenode.net/?channels=hyperdex\&uio=d4}{HyperDex IRC Channel}:
...
\item \hdhref{https://github.com/rescrv/HyperDex/issues}{HyperDex Bug Tracker}:
    ...
    yet been reported.
\item \hdhref{http://hyperdex.org/FAQ/}{HyperDex FAQ}:
    ...
    solve your problems.
\item \hdhref{http://hyperdex.org/papers/}{HyperDex Papers}:
