...
to restrict clients' access to data. 
Authorization in HyperDex uses macaroons, a new decentralized
authorization framework developed by Google for use in distributed systems.
Macaroons enable an application developer to enforce security
...
an example towards the end where we implement a rich security policy
