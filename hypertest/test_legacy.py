...
def test_410_datatype_map_string_string_microops(cfg):
	...
	cfg.must().add_space('''
		space kv
		key k
		attributes v (map(string,string)) 
	''')
	cfg.should().get('kv','k')
