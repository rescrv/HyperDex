...
func main() {
	...
	err = c.Put("kv", "k", client.Attributes{"v": client.Map{int64(1): int64(7), int64(2): int64(8), int64(3): int64(9)}})
	if err.Status != client.SUCCESS {
		os.Exit(1)
	}
	attrs, err = c.Get("kv", "k")
	...
	if !sloppyEqualAttributes(attrs, client.Attributes{"v": client.Map{int64(1): int64(7), int64(2): int64(8), int64(3): int64(9)}}) {
		fmt.Printf("%s %s\n", attrs, client.Map{"v": client.Map{int64(1): int64(7), int64(2): int64(8), int64(3): int64(9)}})
		panic("objects not equal")
	}
